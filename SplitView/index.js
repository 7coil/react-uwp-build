...
exports.SplitView = exports.SplitViewPane = void 0;
    ...
    function SplitView() {
        ...
        _this.addBlurEventMethod = function () {
            ...
            _this.addBlurEvent.setConfig({
                ...
                clickExcludeElm: clickExcludeElms ? __spread(clickExcludeElms, [_this.rootElm]) : _this.rootElm,
            ...
            React.Children.forEach(children, function (child, index) {
                if (child.type === SplitViewPane_1.default) {
                    splitViewPanes.push(React.cloneElement(child, {
                        style: __assign(__assign({}, styles.pane.style), child.props.style),
...
function getStyles(splitView) {
    ...
    return {
        root: prefixStyle(__assign(__assign(__assign(__assign(__assign(__assign({ color: theme.baseHigh }, theme.acrylicTexture60.style), { display: "inline-block", position: "relative", margin: 0, padding: 0, transition: transition }), (isCompact ? {
            flex: "0 0 auto",
            display: "flex",
            flexDirection: "row",
        ...
        pane: prefixStyle(__assign(__assign(__assign(__assign(__assign({}, theme.acrylicTexture40.style), { transition: transition, boxShadow: theme.useFluentDesign ? "rgba(0, 0, 0, 0.34) 0px 4px 24px" : void 0 }), (isCompact ? {
            height: "100%",
            width: expandedWidth,

...
exports.SplitViewCommand = void 0;
...
var SplitViewCommand = /** @class */ (function (_super) {
    ...
    SplitViewCommand.prototype.render = function () {
        var _a = this.props, style = _a.style, className = _a.className, label = _a.label, icon = _a.icon, visited = _a.visited, onMouseEnter = _a.onMouseEnter, onMouseLeave = _a.onMouseLeave, isTenFt = _a.isTenFt, iconStyle = _a.iconStyle, showLabel = _a.showLabel, revealConfig = _a.revealConfig, attributes = __rest(_a, ["style", "className", "label", "icon", "visited", "onMouseEnter", "onMouseLeave", "isTenFt", "iconStyle", "showLabel", "revealConfig"]);
        ...
        return (React.createElement(PseudoClasses_1.default, __assign({}, rootStyleClasses),
            React.createElement("div", __assign({}, attributes),
                ...
                React.createElement(RevealEffect_1.default, __assign({}, revealConfig, { effectRange: "self" })))));
    };
...
function getStyles(splitViewCommand) {
    ...
    return {
        root: prefixStyle(__assign({ flex: "0 0 auto", fontSize: 14, color: theme.baseMediumHigh, border: theme.borderWidth + "px solid transparent", borderWidth: theme.borderWidth + "px 0px", background: isTenFt ? (visited ? theme.listAccentLow : "none") : "none", width: "100%", display: "flex", flexDirection: "row", alignItems: "center", position: "relative", transition: "all .25s 0s ease-in-out", "&:hover": {
